...
10. Rodar o `/review` para avaliar o código e feedbacks.
11. Commita a worktree: git commit -m "Add feature [feature-name]"
12. Cria uma pull request com os commits da worktree.
